<?php
	...
	$dept_sel= $dbobject->getTableSelectArr('dept',array('dept_id','dept_name'),array('1','dept_id!'),array('1','501'),'dept_id','ASC',$dept_id,'Department');
?>
<style type="text/css">
...
<input type="hidden" name="operation" id="operation" value="<?php echo $op; ?>" />
 <input type="hidden" name="posted_user" id="posted_user" class="required-text form-control" title="posted_user" value="<?php echo $_SESSION['username_sess']?>" />
            ...
            <tr>
              <td colspan="4" style="padding:0px !important;"><table width="100%" border="0" cellspacing="0" id="list_table" class="table" style="border-color:#CCC !important;">
                <tr>
                  ...
                  <?php /*?><td width="97" align="right" nowrap="nowrap">Profile Picture :</td>
              <td align="left" class="fdtddd">
                    <input type="file" name="imager" id="imager" class="form-control"/>
                  </td><?php */?>
                </tr>
                <tr>
                  <td align="right" nowrap="nowrap">Password :</td>
                  <td width="380" align="left" class="fdtddd"><input type="password" name="userpassword" id="userpassword" value="<?php echo $recovered_pass; ?>" class="required-alphanumeric form-control" title="Password" /></td>
                  <td width="167" align="right" nowrap="nowrap">Confirm Password :</td>
                  <td width="380" align="left" class="fdtddd"><input type="password" name="npswd" id="npswd" value="<?php echo $recovered_pass; ?>" class="required-alphanumeric form-control" title="Confirm password" /></td>
                </tr>
                <tr>
            ...
            <tr>
              <td colspan="4"><table width="100%" border="0" class="table" cellspacing="0" cellpadding="5" id="list_table">
                <tr>
                  ...
                  <label><input name="day_2" type="checkbox" id="day_2" onchange="javascript: checkOption(this);"checked value=1 />
                   <span class="text"> Monday</span>
                   </label>
                   </div>
                   <div class="checkbox col-lg-2">
                   
                  <label> <input name="day_3" type="checkbox" id="day_3" onchange="javascript: checkOption(this);"checked value=1 />
                   <span class="text"> Tuesday</span>
                   </label>
                   </div>
                   <div class="checkbox col-lg-2">
                  <label> <input name="day_4" type="checkbox" id="day_4" onchange="javascript: checkOption(this);"checked value=1 />
                   <span class="text"> Wednesday</span>
                   </label>
                   </div>
                   <div class="checkbox col-lg-2">
                  <label>  <input name="day_5" type="checkbox" id="day_5" onchange="javascript: checkOption(this);"checked value=1 />
                   <span class="text"> Thursday</span>
                   </label>
                   </div>
                   <div class="checkbox col-lg-2">
                  <label> <input name="day_6" type="checkbox" id="day_6" onchange="javascript: checkOption(this);"checked value=1 />
                   <span class="text">Friday</span>
                   </label>
                   </div>
                   <div class="checkbox col-lg-2">
                  <label>  <input name="day_7" type="checkbox" id="day_7" onchange="javascript: checkOption(this);"checked value=1 />
                ...
                <tr>
                  ...
                  <td align="left"><label>
                    <select name="role_id" id="role_id" class="required-number" title="Role">
                      <?php echo $role_sel; ?>
                    </select>
                  </label></td>
                  <td align="left">Select Department :</td>
                  <td align="left"><label>
                    <select name="dept_id" id="dept_id" class="required-number" title="Department">
                      <?php echo $dept_sel; ?>
                    </select>
                    </label></td>
                  </div>
