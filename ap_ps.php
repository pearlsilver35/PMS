...
<form class="mws-form" action="" method="get" id="form1">
 <input type="hidden" name="operation" id="operation" value="edit"/>
  <input type="hidden" name="ps_appraisal_date-fd" id="ps_appraisal_date-fd" class="required-text form-control" title="" value="<?php echo $ps_appraisal_date; ?>" />
...
<tr>
                  ...
                  <td width="311" align="left" class="fdtddd"><textarea cols="1" rows="1" name="hod_appraisal" id="hod_appraisal" value="<?php echo $hod_appraisal; ?>" class=" form-control" readonly="true"><?php echo $hod_appraisal; ?></textarea></td>
                ...
                <tr>
                  <td align="right" nowrap="nowrap">GH Appraisal :</td>
                  <td width="311" align="left" class="fdtddd"><textarea name="gh_appraisal" id="gh_appraisal" value="<?php echo $gh_appraisal; ?>" class=" form-control" readonly="true"><?php echo $gh_appraisal; ?></textarea></td>
                  <td width="167" align="right" nowrap="nowrap">PS Appraisal :</td>
                  <td  align="left" class="fdtddd"> <textarea cols="1" rows="1" name="ps_appraisal-fd" id="ps_appraisal-fd" value="<?php echo $ps_appraisal; ?>" class="required-text form-control" title="Appraisal"><?php echo $ps_appraisal; ?></textarea>
                  </tr>
                <tr>
                  <td width="97" align="right" nowrap="nowrap">GH Appraisal Date :</td>
  ...
  function calldage()
  {           
             callPageEdit('daily_progress','ap_ps.php','page');
  }
