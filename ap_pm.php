<?php
	...
	if($_REQUEST['op']=='edit')
	{
		...
		if($numrows > 0)
		{
			...
			$pm_appraisal_date = date("Y-m-d H:i:s");
...
#heading_td
{
 ...
 <input type="hidden" name="operation" id="operation" value="edit"/>
  <input type="hidden" name="pm_appraisal_date-fd" id="pm_appraisal_date-fd" class="required-text form-control" title="" value="<?php echo $pm_appraisal_date; ?>" />
...
<tr>
                  ...
                  <td width="167" align="right" nowrap="nowrap">H.O.D Appraisal :</td>
                  <td  align="left" class="fdtddd"><textarea cols="1" rows="1" name="hod_appraisal" id="hod_appraisal" value="<?php echo $hod_appraisal; ?>" class=" form-control" readonly="true"><?php echo $hod_appraisal; ?></textarea>
                  </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td  align="left" class="fdtddd">
                  <textarea cols="1" rows="1" name="pm_appraisal-fd" id="pm_appraisal-fd" value="<?php echo $pm_appraisal; ?>" class="required-text form-control" title="Appraisal" ><?php echo $pm_appraisal; ?></textarea>
                  </tr>
                <tr>
  ...
  function calldage()
  {           
             callPageEdit('daily_progress','ap_pm.php','page');
  }
