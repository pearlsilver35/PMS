...
<?php
	...
	{
		$query = "select * from role where 1=1 and role_id not in(select parameter_value from parameter where parameter_name='001')".$filter.$searchdate.$order.$limit_filter;
	}
	//echo $query;
   ...
   <link href="css/stylesheets.css" rel="stylesheet" type="text/css" />  
    ...
    <table class="table" width="100%">
      ...
      <tr <?php echo ($k%2==0)?"class='treven'":"class='trodd'"; ?> >
        ...
        <td nowrap="nowrap"><a href="javascript:getpage('role.php?op=edit&amp;role_id=<?php echo $row["role_id"];?>','page')"><font color="#33CC00">Edit</font></a>&nbsp;|&nbsp;<a href="javascript:getpage('role_list.php?op=del&amp;role_id=<?php echo $row["role_id"];?>','page')"><font color="#FF0000">Delete</font></a></td>
      </tr>
      <?php 
				} //End If Result Test	
		  ?>
