<?php
	...
	if($_REQUEST['op']=='edit')
	{
		...
		if($numrows > 0)
		{
			...
			$hod_appraisal_date = date("Y-m-d H:i:s");
...
#heading_td
{
 ...
 <input type="hidden" name="operation" id="operation" value="edit"/>
  <input type="hidden" name="hod_appraisal_date-fd" id="hod_appraisal_date-fd" class="required-text form-control" title="" value="<?php echo $hod_appraisal_date; ?>" />
...
<tr>
                ...
                <tr>
                  ...
                  <td  align="left" class="fdtddd"><textarea cols="1" rows="1" name="hod_appraisal-fd" id="hod_appraisal-fd" value="<?php echo $hod_appraisal; ?>" class="required-text form-control" title="Appraisal"><?php echo $hod_appraisal; ?></textarea>
                  </tr>
                <tr>
  ...
  function calldage()
  {           
             callPageEdit('daily_progress','ap_hod.php','page');
  }
